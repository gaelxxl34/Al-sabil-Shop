...
const navLinks = [
  { href: "/seller/dashboard", label: "Dashboard", icon: <FiHome className="w-5 h-5" /> },
...
export default function SellerSidebar({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <aside className={`w-64 flex-shrink-0 flex flex-col h-screen ${SIDEBAR_BG} shadow-xl overflow-y-auto`}>
